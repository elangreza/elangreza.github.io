...
Hi, my name is Muhammad Reza Elang Erlangga here's my email [mrezaelange@gmail.com](mailto:mrezaelange@gmail.com) , applying for Backend Engineer position at Y-ventures, 

This answer test is written in mdx format and hosted at [github](github.com), but i didn't generate the metadata / seo compliance for this link, you can only open this post through my shareable link via [dealls](dealls.com)

you can also see the raw version this post in this github link [here](https://github.com/elangreza/elangreza.github.io/blob/main/app/blog/posts/backend-engineer-take-home-assignment-y-ventures.mdx) or github raw [here](https://raw.githubusercontent.com/elangreza/elangreza.github.io/refs/heads/main/app/blog/posts/backend-engineer-take-home-assignment-y-ventures.mdx) with some github limitation (**broken image rendering and broken code indentation**)

you can set also the *dark theme* or *light theme* on the top right navbar 

OK. Here's my answer for the **Take home test Y-Ventures**

Thank you for your time and consideration

Regards

Muhammad Reza Elang Erlangga
