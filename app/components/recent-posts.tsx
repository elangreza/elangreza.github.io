  ...
  return (
    <section className='py-4'>
      <div className='flex items-center justify-between'>
        ...
        <Link href='/blog' className="mb-3 text-xl tracking-tighter transition-all text-blue-600 dark:text-blue-500 duration-300 hover:text-blue-600 hover:dark:text-blue-400 hover:underline flex align-middle relative py-1 cursor-pointer">
          See all posts
        </Link>
      </div>
      {recentBlogs
